...
const EventOrganizersPage = () => {
  ...
  const fetchEventOrganizers = async () => {
    const response = await client.getEventOrganizers();
    const eventOrganizers = response.EventOrganizersList;
  ...
  const handlePageChange = async (pageNumber) => {
      ...
      await fetchEventOrganizers(pageNumber); 
  };
  ...
  return (
    ...
    <div className={styles.container}>
      <div className={styles.top}>
        ...
        <Link href="/dashboard/eventOrganizers/add">
